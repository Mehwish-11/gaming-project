...
const Header = () => {
  ...
  return (
    <header className="py-1 px-7 flex justify-between items-center sticky top-0 z-50 w-full border-b-[0.3px]
        ...
        <nav className='hidden md:flex lg:gap-8 gap-4'>
            <a href="#" className="realtive py-1 text-lg hover:text-purple-300 transition-colors duration-300 
            after:content-[''] after:absolute after:w-o after:h-0.5 after:bg-purple-400 after:left-0 after:-bottom-0
        ...
        <div id='mobileMenu' className='hidden fixed top-14 right-0 left-0 bg-black p-5 md:hidden'>
            ...
            <div className='flex flex-col gap-3 w-full mt-4'>
                <button className='border-purple-700 py-2 rounded'>
                    Play Now
                </button>

                <button className='bf-gray-500 py-2 rounded'>
                    NFT Store
                </button>
            </div>
        </div>
